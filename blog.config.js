...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kepler452Byte', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个孙中山先生的忠实信徒🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kepler452byte.top/', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Kepler452Byte', // 你的github个人主页 例如 https://github.com/tangly1024
