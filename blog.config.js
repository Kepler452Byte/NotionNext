...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.kepler452byte.top', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2024068300号', // 备案号 闽ICP备XXXXXXX
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-5JK14uUSHm', // Remove the value or replace it with your own google site verification code
